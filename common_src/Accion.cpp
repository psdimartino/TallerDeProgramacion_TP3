...
void Listar::excecute(std::map<std::string, TaTeTi> &tatetis,
...
void Crear::excecute(std::map<std::string, TaTeTi> &tatetis,
                            std::string &nombrePartida, char &jugador) {
...
void Unirse::excecute(std::map<std::string, TaTeTi> &tatetis,
                            std::string &nombrePartida, char &jugador) {
    if (tatetis.count(nombre) == 0) {
...
void Jugar::excecute(std::map<std::string, TaTeTi> &tatetis,
                            std::string &nombrePartida, char &jugador) {
